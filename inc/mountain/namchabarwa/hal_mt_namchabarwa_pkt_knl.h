...
#define HAL_MT_NAMCHABARWA_PCX_TOP_GET_ADDR(offset)                         (HAL_MT_NAMCHABARWA_PCX_TOP_BASE_ADDR + (offset))
...
#define HAL_MT_NAMCHABARWA_PKT_PDMA_GET_ADDR(offset)                        (HAL_MT_NAMCHABARWA_PKT_PDMA_BASE_ADDR + (offset))
...
#define HAL_MT_NAMCHABARWA_PKT_PDMA_CFG_P2H_RX_FIFO_ALM_FULL                HAL_MT_NAMCHABARWA_PKT_PDMA_GET_ADDR(0x38)
#define HAL_MT_NAMCHABARWA_PKT_PDMA_CFG_P2H_TX_FIFO_ALM_FULL                HAL_MT_NAMCHABARWA_PKT_PDMA_GET_ADDR(0x3c)
#define HAL_MT_NAMCHABARWA_PKT_PDMA_CFG_P2E_RX_FIFO_ALM_FULL                HAL_MT_NAMCHABARWA_PKT_PDMA_GET_ADDR(0x40)
#define HAL_MT_NAMCHABARWA_PKT_PDMA_CFG_P2E_TX_FIFO_ALM_FULL                HAL_MT_NAMCHABARWA_PKT_PDMA_GET_ADDR(0x44)
#define HAL_MT_NAMCHABARWA_PKT_PDMA_CFG_FIFO_DEBUG_EN                       HAL_MT_NAMCHABARWA_PKT_PDMA_GET_ADDR(0x50)
#define HAL_MT_NAMCHABARWA_PKT_PDMA_CFG_PDMA2PCIE_INTR_MASK                 HAL_MT_NAMCHABARWA_PKT_PDMA_GET_ADDR(0xA4)
#define HAL_MT_NAMCHABARWA_PKT_PDMA_CFW_PDMA2PCIE_INTR_CLR                  HAL_MT_NAMCHABARWA_PKT_PDMA_GET_ADDR(0xA8)
...
#define HAL_MT_NAMCHABARWA_PKT_PDMA_CFG_CH0_DESC_WORK_IDX                   HAL_MT_NAMCHABARWA_PKT_PDMA_GET_ADDR(0x1A8)
#define HAL_MT_NAMCHABARWA_PKT_PDMA_CFG_CH0_DESC_POP_IDX                    HAL_MT_NAMCHABARWA_PKT_PDMA_GET_ADDR(0x1F8)
...
#define HAL_MT_NAMCHABARWA_PKT_PDMA_IRQ_PDMA_ABNORMAL_INTR_MSK              HAL_MT_NAMCHABARWA_PKT_PDMA_GET_ADDR(0x358)
#define HAL_MT_NAMCHABARWA_PKT_PDMA_STA_PDMA_CH0_ERR_TYPE                   HAL_MT_NAMCHABARWA_PKT_PDMA_GET_ADDR(0x3B0)
#define HAL_MT_NAMCHABARWA_PKT_PDMA_STA_PDMA_CH0_OUTSTD_DESC                HAL_MT_NAMCHABARWA_PKT_PDMA_GET_ADDR(0x400)

#define HAL_MT_NAMCHABARWA_PKT_PDMA_IRQ_PDMA_MALFORM_INTR                   HAL_MT_NAMCHABARWA_PKT_PDMA_GET_ADDR(0xD10)
#define HAL_MT_NAMCHABARWA_PKT_PDMA_CFG_PDMA2PCIE_INTR_MASK_MODE            HAL_MT_NAMCHABARWA_PKT_PDMA_GET_ADDR(0xd1c)
#define HAL_MT_NAMCHABARWA_PKT_PDMA_CFG_PDMA2PCIE_INTR_MASK_ALL             HAL_MT_NAMCHABARWA_PKT_PDMA_GET_ADDR(0xd20)
#define HAL_MT_NAMCHABARWA_PKT_PDMA_CFG_PDMA2PCIE_INTR_CH0_MASK             HAL_MT_NAMCHABARWA_PKT_PDMA_GET_ADDR(0xd24)
#define HAL_MT_NAMCHABARWA_PKT_PDMA_IRQ_PDMA_ABNORMAL_CH0_INTR              HAL_MT_NAMCHABARWA_PKT_PDMA_GET_ADDR(0xd6c)
#define HAL_MT_NAMCHABARWA_PKT_PDMA_IRQ_PDMA_ABNORMAL_CH0_INTR_MSK          HAL_MT_NAMCHABARWA_PKT_PDMA_GET_ADDR(0xd70)
#define HAL_MT_NAMCHABARWA_PKT_PDMA_IRQ_PDMA_ABNORMAL_CH0_INTR_TST          HAL_MT_NAMCHABARWA_PKT_PDMA_GET_ADDR(0xd74)


#define HAL_MT_NAMCHABARWA_PKT_GET_MMIO(__tbl__)                        (0xFFFFFFFF & (__tbl__))
#define HAL_MT_NAMCHABARWA_PKT_GET_PDMA_DWORD_RCH_REG(__tbl__, __channel__) ((__tbl__) + (0x8 * (__channel__)))
#define HAL_MT_NAMCHABARWA_PKT_GET_PDMA_WORD_RCH_REG(__tbl__, __channel__)  ((__tbl__) + (0x4 * (__channel__)))
#define HAL_MT_NAMCHABARWA_PKT_GET_PDMA_DWORD_TCH_REG(__tbl__, __channel__) ((__tbl__) + (0x8 * (__channel__ + 4)))
#define HAL_MT_NAMCHABARWA_PKT_GET_PDMA_WORD_TCH_REG(__tbl__, __channel__)  ((__tbl__) + (0x4 * (__channel__ + 4)))
...
#define HAL_MT_NAMCHABARWA_PKT_SWAP32(__data__)            (((__data__) >> 24) | (((__data__) >> 8) & 0xFF00) | \
                                                            (((__data__) << 8) & 0xFF0000) | ((__data__) << 24))
...
#define HAL_MT_NAMCHABARWA_PKT_PDMA_HDR_SZ             (HAL_MT_NAMCHABARWA_PKT_EMAC_SZ + HAL_MT_NAMCHABARWA_PKT_PPH_HDR_SZ)
#define HAL_MT_NAMCHABARWA_PKT_TX_MAX_LEN              (10200)
#define HAL_MT_NAMCHABARWA_PKT_RX_MAX_LEN              (10200 + HAL_MT_NAMCHABARWA_PKT_PDMA_HDR_SZ) /* EPP tunnel header */
...
#define HAL_MT_NAMCHABARWA_PKT_PDMA_ALIGN_ADDR(pdma_addr, align_sz) (((pdma_addr) + (align_sz)) & 0xFFFFFFFFFFFFFFF0)
#else
#define HAL_MT_NAMCHABARWA_PKT_PDMA_ALIGN_ADDR(pdma_addr, align_sz) (((pdma_addr) + (align_sz)) & 0xFFFFFFF0)
#endif
/*---------------------------------------------------------------------------*/
#define HAL_MT_NAMCHABARWA_PKT_SET_BITMAP(bitmap, mask_bitmap)  (bitmap = ((bitmap) | (mask_bitmap)))
#define HAL_MT_NAMCHABARWA_PKT_CLR_BITMAP(bitmap, mask_bitmap)  (bitmap = ((bitmap) & (~(mask_bitmap))))
...
typedef struct
{
    ...
    UI32_T  src_idx                     :14;    /*"0 - 4K: system wide physical port/lag
    ...
    UI32_T  port_num                    :6;     /*system wide physical port number {die# (in chassis case 4), slice #(4), port #(5)}.*/
    ...
    UI32_T  int_profile                 :3;     /*int profile; reload as  bit0: ioam_color_en, bit1: ioam_delay, bit2: ioam_pkt_color*/
    UI32_T  int_mm_mode                 :1;     /*0: MX; 1: MD. For INT_XD, it is set to MX though it is don’t care. N/A for ioam mode*/
...
// dst idx bit2 bit7
#define HAL_MT_NAMCHABARWA_PKT_PPH_GET_DST_IDX(ptr_pph)       ((ptr_pph != NULL) ? \
            (ptr_pph->dst_idx_hi << 7 | ptr_pph->dst_idx_lo) : 0xffffffff)
...
#define HAL_MT_NAMCHABARWA_PKT_PPH_GET_IGR_ACL_LABLE(ptr_pph)       ((ptr_pph != NULL) ? \
            (ptr_pph->igr_acl_label_hi << 6 | ptr_pph->igr_acl_label_lo) : 0xffffffff)
...
// evpn_esi bit4 bit16
#define HAL_MT_NAMCHABARWA_PKT_PPH_GET_EVPN_ESI(ptr_pph)       ((ptr_pph != NULL) ? \
            (ptr_pph->evpn_esi_hi << 16 | ptr_pph->evpn_esi_lo) : 0xffffffff)
...
// tnl_bd bit2 bit7
#define HAL_MT_NAMCHABARWA_PKT_PPH_GET_TNL_BD(ptr_pph)       ((ptr_pph != NULL) ? \
            (ptr_pph->tnl_bd_hi << 7 | ptr_pph->tnl_bd_lo) : 0xffffffff)
...
// ptp_info bit6 bit26
#define HAL_MT_NAMCHABARWA_PKT_PPH_GET_PTP_INFO(ptr_pph)       ((ptr_pph != NULL) ? \
            (ptr_pph->ptp_info_hi << 26 | ptr_pph->ptp_info_lo) : 0xffffffff)
...
#define HAL_MT_NAMCHABARWA_PKT_PPH_GET_MAC_DA(ptr_pph)       ((ptr_pph != NULL) ? \
            ((UI64_T)((UI64_T)ptr_pph->mac_da_hi << 47 | ptr_pph->mac_da_mi << 15 | ptr_pph->mac_da_lo)) : 0xffffffff)
...
// mpls_lbl bit4 bit16
#define HAL_MT_NAMCHABARWA_PKT_PPH_GET_MPLS_LBL(ptr_pph)       ((ptr_pph != NULL) ? \
            (ptr_pph->mpls_lbl_hi << 16 | ptr_pph->mpls_lbl_lo) : 0xffffffff)
...
#if defined(CLX_EN_HOST_32_BIT_BIG_ENDIAN) || defined(CLX_EN_HOST_64_BIT_BIG_ENDIAN)
//dst_idx
#define HAL_MT_NAMCHABARWA_PKT_PPH_GET_DST_IDX(ptr_pph)         ((ptr_pph != NULL) ? ptr_pph->dst_idx : 0xffffffff)
#define HAL_MT_NAMCHABARWA_PKT_PPH_SET_DST_IDX(ptr_pph,dst_idx) { \
    if(ptr_pph != NULL)                                             \
    { \
...
//igr_acl_label
#define HAL_MT_NAMCHABARWA_PKT_PPH_GET_IGR_ACL_LABLE(ptr_pph)   ((ptr_pph != NULL) ? ptr_pph->igr_acl_label : 0xffffffff)
#define HAL_MT_NAMCHABARWA_PKT_PPH_SET_IGR_ACL_LABLE(ptr_pph,igr_acl_label) { \
    if(ptr_pph != NULL)                                             \
    { \
...
// evpn_esi
#define HAL_MT_NAMCHABARWA_PKT_PPH_GET_EVPN_ESI(ptr_pph)       ((ptr_pph != NULL) ? ptr_pph->evpn_esi : 0xffffffff)
#define HAL_MT_NAMCHABARWA_PKT_PPH_SET_EVPN_ESI(ptr_pph,evpn_esi) { \
    if(ptr_pph != NULL)                                             \
    { \
...
// tnl_bd
#define HAL_MT_NAMCHABARWA_PKT_PPH_GET_TNL_BD(ptr_pph)       ((ptr_pph != NULL) ? ptr_pph->tnl_bd : 0xffffffff)
#define HAL_MT_NAMCHABARWA_PKT_PPH_SET_TNL_BD(ptr_pph,tnl_bd) { \
    if(ptr_pph != NULL)                                         \
    { \
...
// ptp_info
#define HAL_MT_NAMCHABARWA_PKT_PPH_GET_PTP_INFO(ptr_pph)       ((ptr_pph != NULL) ? ptr_pph->ptp_info : 0xffffffff)
#define HAL_MT_NAMCHABARWA_PKT_PPH_SET_PTP_INFO(ptr_pph,ptp_info) { \
    if(ptr_pph != NULL)                                             \
    { \
...
// mac_da
#define HAL_MT_NAMCHABARWA_PKT_PPH_GET_MAC_DA(ptr_pph)       ((ptr_pph != NULL) ? ptr_pph->mac_da : 0xffffffffffffffff)
#define HAL_MT_NAMCHABARWA_PKT_PPH_SET_MAC_DA(ptr_pph,mac_da) { \
    if(ptr_pph != NULL)                                         \
    { \
...
// mpls_lbl
#define HAL_MT_NAMCHABARWA_PKT_PPH_GET_MPLS_LBL(ptr_pph)       ((ptr_pph != NULL) ? ptr_pph->mpls_lbl : 0xffffffff)
#define HAL_MT_NAMCHABARWA_PKT_PPH_SET_MPLS_LBL(ptr_pph,mpls_lbl) { \
    if(ptr_pph != NULL)                                             \
    { \
...
typedef struct
{
    ...
    HAL_MT_NAMCHABARWA_PKT_NETIF_PROFILE_T     net_profile;    /* createProfile[In,Out], destroyProfile[In] */
...
/* ----------------------------------------------------------------------------------- pkt_drv */
#if defined(CLX_LAMP)
/* FUNCTION NAME: hal_mt_namchabarwa_pkt_sendGpdToCmodel
 * PURPOSE:
 ...
 */
CLX_ERROR_NO_T
hal_mt_namchabarwa_pkt_sendGpdToCmodel(
    const UI32_T                    unit,
...
/* ----------------------------------------------------------------------------------- pkt_srv */
/* FUNCTION NAME: hal_mt_namchabarwa_pkt_sendPacket
 * PURPOSE:
 ...
 */
CLX_ERROR_NO_T
hal_mt_namchabarwa_pkt_sendPacket(
    const UI32_T                    unit,
    const UI32_T                    channel,
    const CLX_PKT_TX_PKT_T          *ptr_tx_pkt);

/* FUNCTION NAME: hal_mt_namchabarwa_pkt_invokeRxUsrCallback
 * PURPOSE:
 ...
 */
HAL_MT_NAMCHABARWA_PKT_CALLBACK_NO_T
hal_mt_namchabarwa_pkt_invokeRxUsrCallback(
    const UI32_T                    unit,
...
/* FUNCTION NAME: hal_mt_namchabarwa_pkt_init
 * PURPOSE:
