...
typedef struct
{
    ...
    HAL_LT_LIGHTNING_PKT_NETIF_PROFILE_T     net_profile;    /* createProfile[In,Out], destroyProfile[In] */
...
/* ----------------------------------------------------------------------------------- pkt_drv */
#if defined(CLX_LAMP)
/* FUNCTION NAME: hal_lt_lightning_pkt_sendGpdToCmodel
 * PURPOSE:
 ...
 */
CLX_ERROR_NO_T
hal_lt_lightning_pkt_sendGpdToCmodel(
    const UI32_T                    unit,
...
/* FUNCTION NAME: hal_lt_lightning_pkt_init
 * PURPOSE:
