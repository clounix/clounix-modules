...
typedef enum
{
    ...
    CHANNEL_CPU_TO_LOCALBUS = 8,
    CHANNEL_LOCALBUS_TO_CPU,
    CHANNEL_LOCALBUS_TO_LOCALBUS,
    CHANNEL_CPU_TO_ECPU,
    CHANNEL_ECPU_TO_CPU,
    CHANNEL_ECPU_TO_ECPU,
    CHANNEL_LOCALBUS_TO_ECPU,
    CHANNEL_ECPU_TO_LOCALBUS,
...
#define HAL_NB_PDMA_GENERAL_CHANNEL_NUM    (HAL_NB_PDMA_GENERAL_CHANNEL_LAST - HAL_NB_PDMA_GENERAL_CHANNEL_0) 
