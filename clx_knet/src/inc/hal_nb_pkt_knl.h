...
#define HAL_NB_PDMA_CFG_FIFIO_PATH_SEL                      (0x30)
#define HAL_NB_PDMA_CFG_CRC_EN                              (0x34)
#define HAL_NB_PDMA_CFG_P2H_RX_FIFO_ALM_FULL                (0x38)
#define HAL_NB_PDMA_CFG_P2H_TX_FIFO_ALM_FULL                (0x3c)
#define HAL_NB_PDMA_CFG_P2E_RX_FIFO_ALM_FULL                (0x40)
#define HAL_NB_PDMA_CFG_P2E_TX_FIFO_ALM_FULL                (0x44)
#define HAL_NB_PDMA_CFG_FIFO_DEBUG_EN                       (0x50)
#define HAL_NB_PDMA_CFG_PDMA_INTR_MASK                      (0xA4)
#define HAL_NB_PDMA_CFG_CH0_RING_BASE                       (0xB8)
#define HAL_NB_PDMA_CFG_CH0_RING_SIZE                       (0x158)
#define HAL_NB_PDMA_CFG_CH0_DESC_WORK_IDX                   (0x1A8)
#define HAL_NB_PDMA_CFG_CH0_DESC_POP_IDX                    (0x1F8)
#define HAL_NB_PDMA_CFG_CH0_MODE                            (0x248)
#define HAL_NB_PDMA_CFW_GLOBAL_RESET                        (0x348)
#define HAL_NB_PDMA_CFW_CHANNEL_RESET                       (0x34c)
#define HAL_NB_PDMA_CFW_CHANNEL_RESTART                     (0x350)
#define HAL_NB_PDMA_IRQ_ABNORMAL_INTR                       (0x354)
